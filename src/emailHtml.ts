...
<body>
    ...
    <div class="email-container">
        ...
        <div class="game-body">
            ...
            <div class="message-banner" [text]="gameState.lastMessage">
                Guess the word!
            </div>
            ...
            <div class="definitions-section">
                <div class="section-label">
                    ...
                    <span [text]="gameState.revealedCount + ' of ' + gameState.totalDefinitions">1 of 5</span>
                </div>
                <div class="definitions-cards">
                    <div class="definition-card" [hidden]="!gameState.allDefinitions[0]">
                        <span class="def-number">1.</span>
                        <span [class]="gameState.revealedCount > 0 ? '' : 'definition-text-blurred'" [text]="gameState.allDefinitions[0] || ''"></span>
                    </div>
                    <div class="definition-card" [hidden]="!gameState.allDefinitions[1]">
                        <span class="def-number">2.</span>
                        <span class="definition-text-blurred" [class]="gameState.revealedCount > 1 ? '' : 'definition-text-blurred'" [text]="gameState.allDefinitions[1] || ''"></span>
                    </div>
                    <div class="definition-card" [hidden]="!gameState.allDefinitions[2]">
                        <span class="def-number">3.</span>
                        <span class="definition-text-blurred" [class]="gameState.revealedCount > 2 ? '' : 'definition-text-blurred'" [text]="gameState.allDefinitions[2] || ''"></span>
                    </div>
                    <div class="definition-card" [hidden]="!gameState.allDefinitions[3]">
                        <span class="def-number">4.</span>
                        <span class="definition-text-blurred" [class]="gameState.revealedCount > 3 ? '' : 'definition-text-blurred'" [text]="gameState.allDefinitions[3] || ''"></span>
                    </div>
                    <div class="definition-card" [hidden]="!gameState.allDefinitions[4]">
                        <span class="def-number">5.</span>
                        <span class="definition-text-blurred" [class]="gameState.revealedCount > 4 ? '' : 'definition-text-blurred'" [text]="gameState.allDefinitions[4] || ''"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="synonyms-section">
                <div class="section-label">
                    ...
                    <span>Guesses: <span class="stats-val" [text]="gameState.guessCount">0</span></span>
                </div>
                <div class="mask-grid">
                    <div class="mask-tile" [text]="gameState.letterMask[0] || '_'">_</div>
                    <div class="mask-tile" [text]="gameState.letterMask[1] || '_'">_</div>
                    <div class="mask-tile" [text]="gameState.letterMask[2] || '_'">_</div>
                    <div class="mask-tile" [text]="gameState.letterMask[3] || '_'">_</div>
                    <div class="mask-tile" [text]="gameState.letterMask[4] || '_'">_</div>
                    <div class="mask-tile" [text]="gameState.letterMask[5] || '_'" hidden [hidden]="gameState.wordLength < 6">_</div>
                    <div class="mask-tile" [text]="gameState.letterMask[6] || '_'" hidden [hidden]="gameState.wordLength < 7">_</div>
                </div>
            </div>
            ...
            <div class="form-container" [hidden]="gameState.hasWon">
                ...
                <form id="hint-form" method="POST" action-xhr="https://relatle.dev/api/hint" hidden
                    on="submit-success:AMP.setState({ gameState: event.response });
                        submit-error:AMP.setState({ gameState: { lastMessage: event.response.lastMessage || '⚠️ Could not process hint request. Please try again.' } })">
                    <input type="hidden" name="email" value="player@company.com" [value]="gameState.userEmail">
                </form>
            </div>
            ...
            <div class="win-card" hidden [hidden]="!gameState.hasWon">
                ...
                <div class="win-score" [text]="'Final Score: ' + gameState.score + ' Points!'">Final Score: 1000 Points!</div>
                <p style="font-size: 12px; color: #d1fae5; margin-bottom: 6px;">Share your score with your organization:</p>
                <div class="share-box" [text]="gameState.shareText">
                    RELATLE #1
                    🎯 Solved in 1 guess!
                    ⭐ Score: 1000 pts | Org Rank: #1
                </div>
            </div>

            <!-- Compact Subscribe Banner Box -->
