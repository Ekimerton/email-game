...
<body>
    <div class="email-wrapper">
        ...
        <div class="leaderboard-section">
            <amp-list id="leaderboardList" width="auto" height="100" layout="fixed-height"
        ...
        <!-- Footer -->
        <div class="footer">
            <a class="account-link" href="https://inboxed.fun/account?token=default-dev-token">Manage
