...
<head>
    ...
    <style amp-custom>
        ...
        * {
        ...
        /* Flowing Card Corners */
        .card.header-card,
        .card:first-of-type {
            border-radius: 12px 12px 0 0;
        }

        .card.how-to-play-section,
        .card:last-of-type {
            border-radius: 0 0 12px 12px;
        }

        /* Header Card with Dark Blue Background & White Text */
        .header-card {
            background: #1e3a8a;
        ...
        .header-card .game-number-compact,
        .header-card .header-date-compact {
            color: #ffffff;
            opacity: 0.85;
            font-size: 11px;
            font-weight: 700;
        ...
        .header-card .header-title-centered {
            color: #ffffff;
            font-size: 20px;
            font-weight: 900;
            letter-spacing: 3.5px;
            font-family: 'Righteous', 'Arial Rounded MT Bold', 'Impact', -apple-system, sans-serif;
            margin: 1px 0 2px;
            line-height: 1.15;
            text-transform: uppercase;
        }

        .header-card .game-intro-text {
            color: #ffffff;
            opacity: 0.85;
            font-size: 11px;
            font-weight: 500;
...
<body>
    <div class="email-wrapper">
        <!-- Top Header Card: Dark blue background, white text -->
        <div class="card header-card">
            ...
            <div class="game-hero">
                ...
                <p class="game-intro-text">The daily email game. Forward an invite to your friends!</p>
            </div>
        </div>
